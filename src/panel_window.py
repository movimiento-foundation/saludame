...
PANEL_BG_PATH = os.path.join(BASEPATH, "assets/layout/panel.png")
...
class PanelWindow(gui.Window):
    ...
    def __init__(self, container, rect, frame_rate, windows_controller):
        ...
        self.image_info_blink = os.path.join(BASEPATH,"assets/layout/info.png")
        ...
        # Customization
        customization_button = gui.ImageButton(self.rect, pygame.Rect(953, 0, 1, 1), 1, os.path.join(BASEPATH,"assets/layout/customization.png"), self._cb_button_click_customization)
        customization_button.set_tooltip(_("Customization module"))
        self.add_button(customization_button)
        
        # Info
        self.info_button = gui.ImageButton(self.rect, pygame.Rect(885, 0, 1, 1), 1, os.path.join(BASEPATH,"assets/layout/info.png"), self._cb_button_click_info)
    ...
    def update(self, frames):
        ...
        if frames % 8 == 0:
            if self.info_button_event and self.info_button_blink_timeout:
                ...
                if self.image_info_blink == os.path.join(BASEPATH,"assets/layout/info.png"):
                    self.info_button.switch_image_background(os.path.join(BASEPATH,"assets/layout/info2.png"))
                    self.image_info_blink = os.path.join(BASEPATH,"assets/layout/info2.png")
                else:
                    self.info_button.switch_image_background(os.path.join(BASEPATH,"assets/layout/info.png"))
                    self.image_info_blink = os.path.join(BASEPATH,"assets/layout/info.png")
...
class ActionProgressBar(gui.Widget):
    ...
    def __init__(self, container, rect_in_container, frame_rate, action):
        ...
        self.action = action
        surface = pygame.image.load(os.path.join(BASEPATH,"assets/layout/progress_bar_back.png")).convert_alpha()
