...
class PersonalWindow(gui.Window):
    def __init__(self, container, rect, frame_rate, windows_controller):
        ...
        self.personal_next = gui.ImageButton(self.rect, pygame.Rect(120, 95, 30, 30), 1, os.path.join(BASEPATH,"assets/events/go-next.png"), self._cb_button_click_personal_next)
        self.personal_back = gui.ImageButton(self.rect, pygame.Rect(5, 95, 30, 30), 1, os.path.join(BASEPATH,"assets/events/go-back.png"), self._cb_button_click_personal_back)
...
class SocialWindow(gui.Window):
    def __init__(self, container, rect, frame_rate, windows_controller):
        ...
        self.social_next = gui.ImageButton(self.rect, pygame.Rect(120, 95, 30, 30), 1, os.path.join(BASEPATH,"assets/events/go-next.png"), self._cb_button_click_social_next)
        self.social_back = gui.ImageButton(self.rect, pygame.Rect(5, 95, 30, 30), 1, os.path.join(BASEPATH,"assets/events/go-back.png"), self._cb_button_click_social_back)
