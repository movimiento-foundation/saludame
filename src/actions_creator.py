...
#SOUNDS
BLIP_PATH = os.path.join(BASEPATH, "assets/sound/blip.ogg")
CHANGE_PLACE_PATH = os.path.join(BASEPATH, "assets/sound/place_change.ogg")
CHANGE_CLOTHES_PATH = os.path.join(BASEPATH, "assets/sound/clothes_change.ogg")
TWISTER_SOUND = os.path.join(BASEPATH, "assets/sound/place_change.ogg")

#ANIMATIONS
CHANGE_CLOTHES_ANIMATION_PATH = os.path.join(BASEPATH, "assets/kid/actions/twister")
CHEW_PATH = os.path.join(BASEPATH, "assets/kid/actions/eat")
DRINK_PATH = os.path.join(BASEPATH, "assets/kid/actions/drink")
TWISTER_PATH = os.path.join(BASEPATH, "assets/kid/actions/twister")

# Action Icons
FRUIT_PATH = os.path.join(BASEPATH, "assets/action-icons/fruits")
BREAKFAST_PATH = os.path.join(BASEPATH, "assets/action-icons/breakfast")
DISH_PATH = os.path.join(BASEPATH, "assets/action-icons/dish")
ORCHARD_PATH = os.path.join(BASEPATH, "assets/action-icons/orchard")
COLD_DRINK_PATH = os.path.join(BASEPATH, "assets/action-icons/colddrink")
HOT_DRINK_PATH = os.path.join(BASEPATH, "assets/action-icons/hotdrink")
...
actions_list = [
    ...
    ("attention", 0.3, 40, 0, os.path.join(BASEPATH, "assets/kid/actions/atention"), 3, 1, None, 4, os.path.join(BASEPATH, "assets/sound/atention.ogg"),
    ...
    ("mate", 0.3, 70, 0, DRINK_PATH, 3, 1, os.path.join(BASEPATH, "assets/action-icons/mate"), 4, BLIP_PATH,
    ...
    # Sports
    ("sport_football", 0.3, 70, 0, os.path.join(BASEPATH, "assets/kid/actions/football"), 3, 1, None, 1, None,
    ...
    ("sport_jump", 0.3, 70, 0, os.path.join(BASEPATH, "assets/kid/actions/ropejump"), 3, 1, None, 1, os.path.join(BASEPATH, "assets/sound/jump_rope.ogg"),
    ...
    ("sport_run", 0.3, 70, 0, os.path.join(BASEPATH, "assets/kid/actions/run"), 3, 1, None, 1, None,
    ...
    # Do
    ("housekeeping", 0.3, 70, 1, TWISTER_PATH, 3, 2, os.path.join(BASEPATH, "assets/action-icons/clean"), 1, [TWISTER_SOUND, os.path.join(BASEPATH, "assets/sound/work.ogg")],
        effects.Effect([("energy",-5), ("shower",-5), ("w_hands",-5), ("sports",10), ("fun",-20), ("relaxing",-5), ("housekeeping",60)]), None, None, None, None
    ),
    ("homework", 0.3, 70, 0, os.path.join(BASEPATH, "assets/kid/actions/read"), 3, 1, None, 1, os.path.join(BASEPATH, "assets/sound/work.ogg"),
        effects.Effect([("energy",-5), ("weight",-0.5), ("fun",-20), ("relaxing",-5), ("homework",80)], ["contento_deberes"]), None, None, None, None
    ),
    ("study_xo", 0.3, 70, 0, os.path.join(BASEPATH, "assets/kid/actions/studyXO"), 3, 1, None, 1, os.path.join(BASEPATH, "assets/sound/play_xo.ogg"),
        effects.Effect([("energy",-5), ("weight",-0.5), ("sports",-5), ("fun",-10), ("relaxing",-5), ("homework",60)]), None, None, None, None
    ),
    ("help_field", 0.3, 70, 1, TWISTER_PATH, 3, 2, None, 1, [TWISTER_SOUND, os.path.join(BASEPATH, "assets/sound/work.ogg")],
    ...
    ("help_cook", 0.3, 70, 1, TWISTER_PATH, 3, 1, os.path.join(BASEPATH, "assets/action-icons/cook"), 1, [TWISTER_SOUND, os.path.join(BASEPATH, "assets/sound/work.ogg")],
    ...
    ("relax", 0.3, 70, 0, os.path.join(BASEPATH, "assets/kid/actions/rest"), 3, 1, None, 1, [os.path.join(BASEPATH, "assets/sound/relax.ogg")],
    ...
    ("talk", 0.3, 70, 0, None, 3, 1, os.path.join(BASEPATH, "assets/action-icons/talktofriend"), 1, os.path.join(BASEPATH, "assets/sound/talk.ogg"),
        effects.Effect([("fun",30)]), None, None, None, None
    ),
    ("clean", 0.3, 70, 1, TWISTER_PATH, 3, 1, os.path.join(BASEPATH, "assets/action-icons/clean"), 2, [TWISTER_SOUND, os.path.join(BASEPATH, "assets/sound/work.ogg")],
        effects.Effect([("energy",-5), ("w_hands",-5), ("sports",10), ("fun",-20), ("relaxing",-5), ("housekeeping",40)]), None, None, None, None
    ),
    ("sleep", 0.3, 150, 1, os.path.join(BASEPATH, "assets/kid/actions/sleep"), 3, 1, None, 4, [None, os.path.join(BASEPATH, "assets/sound/sleep.ogg")],
    ...
    ("wash_hands", 0.3, 80, 1, TWISTER_PATH, 3, 1, os.path.join(BASEPATH, "assets/action-icons/washhands"), 2, [TWISTER_SOUND, os.path.join(BASEPATH, "assets/sound/wash_hands.ogg")],
    ...
    ("brush_teeth", 0.3, 80, 0, os.path.join(BASEPATH, "assets/kid/actions/brushteeth"), 3, 1, None, 1, os.path.join(BASEPATH, "assets/sound/brush_teeth.ogg"),
    ...
    ("shower", 0.3, 150, 1, TWISTER_PATH, 3, 1, os.path.join(BASEPATH, "assets/action-icons/shower"), 2, [TWISTER_SOUND, os.path.join(BASEPATH, "assets/sound/shower.ogg")],
    ...
    ("toilet", 0.3, 120, 1, os.path.join(BASEPATH, "assets/kid/actions/toilet"), 3, 1, None, 2, [TWISTER_SOUND, os.path.join(BASEPATH, "assets/sound/toilet.ogg")],
        effects.Effect([("w_hands",-30), ("toilet",90), ("fun",-10)]), None, None, None, None
    ),
    
    # Farm
    ("farm_plow", 0.3, 70, 1, TWISTER_PATH, 3, 1, os.path.join(BASEPATH, "assets/action-icons/trident"), 2, [TWISTER_SOUND, os.path.join(BASEPATH, "assets/sound/farm.ogg")],
    ...
    ("farm_sow", 0.3, 70, 1, TWISTER_PATH, 3, 1, os.path.join(BASEPATH, "assets/action-icons/sow"), 2, [TWISTER_SOUND, os.path.join(BASEPATH, "assets/sound/farm.ogg")],
        effects.Effect([("energy",-5), ("w_hands",-10), ("fun",10), ("farm",25)]), None, None, None, "huerta_sembrar", 1, u"50-Huerta/04-Sembrar/default.html"
    ),
    ("farm_irrigate", 0.3, 70, 1, TWISTER_PATH, 3, 1, os.path.join(BASEPATH, "assets/action-icons/irrigate"), 2, [TWISTER_SOUND, os.path.join(BASEPATH, "assets/sound/farm.ogg")],
    ...
    ("farm_fumigate", 0.3, 70, 1, TWISTER_PATH, 3, 1, os.path.join(BASEPATH, "assets/action-icons/fumigate"), 2, [TWISTER_SOUND, os.path.join(BASEPATH, "assets/sound/farm.ogg")],
    ...
    ("farm_clean", 0.3, 70, 1, TWISTER_PATH, 3, 1, os.path.join(BASEPATH, "assets/action-icons/sow"), 2, [TWISTER_SOUND, os.path.join(BASEPATH, "assets/sound/farm.ogg")],
    ...
    ("farm_harvest", 0.3, 70, 1, TWISTER_PATH, 3, 1, os.path.join(BASEPATH, "assets/action-icons/harvest"), 2, [TWISTER_SOUND, os.path.join(BASEPATH, "assets/sound/farm.ogg")],
    ...
    # Fun
    ("playXO", 0.3, 70, 0, os.path.join(BASEPATH, "assets/kid/actions/playXO"), 3, 1, None, 1, os.path.join(BASEPATH, "assets/sound/play_xo.ogg"),
    ...
    ("hidenseek", 0.3, 70, 0, os.path.join(BASEPATH, "assets/kid/actions/hidenseek"), 3, 1, None, 1, os.path.join(BASEPATH, "assets/sound/hidenseek.ogg"),
        effects.Effect([("energy",-5), ("weight",-1), ("shower",-10), ("w_hands",-5), ("sports",10), ("fun",60), ("relaxing",-5)]), None, None, None, None, 4
    ),
    ("hopscotch", 0.3, 92, 2, os.path.join(BASEPATH, "assets/kid/actions/hopscotch"), 3, 1, None, 2, os.path.join(BASEPATH, "assets/sound/hopscotch.ogg"),
        effects.Effect([("energy",-5), ("weight",-1), ("shower",-10), ("w_hands",-5), ("sports",10), ("fun",60), ("relaxing",-5)]), None, None, None, None
    ),
    ("tv", 0.3, 70, 0, os.path.join(BASEPATH, "assets/kid/actions/tv"), 3, 1, None, 1, None,
    ...
    ("read", 0.3, 70, 0, os.path.join(BASEPATH, "assets/kid/actions/read"), 3, 1, None, 1, os.path.join(BASEPATH, "assets/sound/work.ogg"),
        effects.Effect([("energy",5), ("fun",50), ("relaxing",5)]), None, None, None, None, 1, None
    ),
    ("music", 0.3, 70, 0, os.path.join(BASEPATH, "assets/kid/actions/dance"), 3, 1, None, 1, os.path.join(BASEPATH, "assets/sound/music.ogg"),
        effects.Effect([("fun",50), ("relaxing",5)]), None, None, None, None, 1, None
    ),
    #("sing", 0.3, 70, 1, os.path.join(BASEPATH, "assets/kid/actions/sing"), 3, 1, None, 4, None,
        #effects.Effect([("fun", 4.0)]), None, None, None, None, 1, None
    #),
    ("crazy", 0.3, 70, 0, os.path.join(BASEPATH, "assets/kid/actions/crazy"), 3, 1, None, 1, os.path.join(BASEPATH, "assets/sound/crazy.ogg"),
        effects.Effect([("energy",-5), ("fun",40)]), None, None, None, None, 2
    ),
    ("dance", 0.3, 70, 0, os.path.join(BASEPATH, "assets/kid/actions/dance"), 3, 1, None, 1, os.path.join(BASEPATH, "assets/sound/music.ogg"),
    ...
    # Go to
    ("dentist", 0.3, 80, 1, TWISTER_PATH, 3, 1, os.path.join(BASEPATH, "assets/action-icons/dentist"), 1, [TWISTER_SOUND, os.path.join(BASEPATH, "assets/sound/dentist.ogg")],
        effects.Effect([("h_check",80)]), None, None, None, None, 1, u"04-Más hábitos saludables/07-Salud bucal-avanzado.html"
    ),
    ("doctor", 0.3, 80, 1, TWISTER_PATH, 3, 1, os.path.join(BASEPATH, "assets/action-icons/doctor"), 1, [TWISTER_SOUND, os.path.join(BASEPATH, "assets/sound/dentist.ogg")],
