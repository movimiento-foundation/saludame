...
music = {
    "happy": os.path.join(BASEPATH,"assets/music/happy.ogg"),
    "normal": os.path.join(BASEPATH,"assets/music/normal.ogg"),
    "sad": os.path.join(BASEPATH,"assets/music/sad.ogg"),
    "angry": os.path.join(BASEPATH,"assets/music/angry.ogg"),
    "sick": os.path.join(BASEPATH,"assets/music/sick.ogg"),
}
...
class SoundManager(GObject.Object):
    ...
    def play_time_change(self):
        pygame.mixer.Sound(os.path.join(BASEPATH,"assets/sound/time_change.ogg")).play()

    def play_event_solved(self):
        pygame.mixer.Sound(os.path.join(BASEPATH,"assets/sound/challenge_win.ogg")).play()
        
    def play_forbidden_action(self):
        pygame.mixer.Sound(os.path.join(BASEPATH,"assets/sound/alert.ogg")).play(2)
    
    def play_popup(self):
        pygame.mixer.Sound(os.path.join(BASEPATH,"assets/sound/popup.ogg")).play()
