...
class AppLoader:
    ...
    def get_weather_list(self):
        ...
        weather = [("warm", _("Warm"), 35.0, "assets/events/weather/warm.png", 1),
                   ("rainy", _("Rainy"), 25.0, "assets/events/weather/rainy.png", 3),
    ...
    def __load_events(self, bars_controller):
        ...
        event = events.PersonalEvent("assets/events/personal/headache", None, "headache", u"Dolor de cabeza", "neg", "random", None, probability, effect, u"Me duele la cabeza", "h.g74q9s1oppgx", 1, sick_1)
        _events.append(event)
