...
bars_rate_per_minute = [("energy",-20), ("defenses",-10), ("weight",0), ("nutrition",-float(100)/16), ("shower",-10), ("w_hands",-10), ("b_teeth",-10), ("toilet",-20), ("sports",-10), ("fun",-10), ("relaxing",-10), ("housekeeping",-20), ("homework",-20), ("h_check",-0.2), ("farm",0)]
...
actions_list = [
    ...
    ("agua_c_gas", 0.3, 70, 0, DRINK_PATH, 3, 1, COLD_DRINK_PATH, 4, BLIP_PATH,
        effects.Effect(None, [("agua",25), ("defenses",10), ("toilet",-10)]), None, None, None
    ),
    ...
    ("leche", 0.3, 70, 0, DRINK_PATH, 3, 1, HOT_DRINK_PATH, 4, BLIP_PATH,
        effects.Effect(None, [("l_quesos",50), ("agua",12.5), ("energy",20), ("defenses",10), ("b_teeth",-10), ("toilet",-10)], CONS_FOOD), None, [], None
    ),
    ...
    ("yogur", 0.3, 70, 0, DRINK_PATH, 3, 1, COLD_DRINK_PATH, 4, BLIP_PATH,
        effects.Effect(None, [("l_quesos",50), ("energy",10), ("b_teeth",-10), ("toilet",-10)], CONS_FOOD), None, [], None
    ),
    ...
    ("sopa_verduras", 0.3, 70, 0, CHEW_PATH, 3, 1, DISH_PATH, 4, BLIP_PATH,
        effects.Effect(None, [("v_frutas",20), ("agua",12.5), ("energy",20), ("b_teeth",-30), ("toilet",-30)], CONS_MEAL), None, None, None),
    ...
    ("g_arroz_carne_lenteja_verdura", 0.3, 70, 0, CHEW_PATH, 3, 1, DISH_PATH, 4, BLIP_PATH,
        effects.Effect(None, [("c_leguminosas",40), ("v_frutas",20), ("c_huevos",50), ("g_aceites",50), ("agua",12.5), ("energy",20), ("b_teeth",-30), ("toilet",-30)], CONS_MEAL), None, None, None),
    ...
    ("guiso_berenjenas", 0.3, 70, 0, CHEW_PATH, 3, 1, ORCHARD_PATH, 4, BLIP_PATH,
        effects.Effect(None, [("c_leguminosas",40), ("v_frutas",40), ("c_huevos",50), ("g_aceites",50), ("agua",12.5), ("energy",20), ("defenses",5), ("b_teeth",-30), ("toilet",-30)], CONS_FOOD), None, None, None),
    ...
    ("manzana", 0.3, 70, 0, CHEW_PATH, 3, 1, FRUIT_PATH, 4, BLIP_PATH,
        effects.Effect(None, [("v_frutas",20), ("energy",10), ("b_teeth",-10), ("toilet",-10)], CONS_FOOD), None, None, None
    ),
    ...
    ("galletitas_dulces", 0.3, 70, 0, CHEW_PATH, 3, 1, BREAKFAST_PATH, 4, BLIP_PATH,
        effects.Effect(None, [("dulces",50), ("energy",20), ("weight",1), ("b_teeth",-20), ("toilet",-10)], CONS_FOOD), None, None, None
    ),
    ("alfajor", 0.3, 70, 0, CHEW_PATH, 3, 1, BREAKFAST_PATH, 4, BLIP_PATH,
        effects.Effect(None, [("c_leguminosas",10), ("dulces",50), ("g_aceites",50), ("energy",20), ("weight",1), ("b_teeth",-20), ("toilet",-10)], CONS_FOOD), None, None, None
    ),
    ("chicle", 0.3, 70, 0, CHEW_PATH, 3, 1, BREAKFAST_PATH, 4, BLIP_PATH,
        effects.Effect(None, [("dulces",25), ("energy",10), ("weight",1), ("b_teeth",-20), ("toilet",-10)], CONS_FOOD), None, None, None
    ),
    ("chocolate", 0.3, 70, 0, CHEW_PATH, 3, 1, BREAKFAST_PATH, 4, BLIP_PATH,
        effects.Effect(None, [("dulces",50), ("g_aceites",50), ("energy",20), ("weight",1), ("b_teeth",-20), ("toilet",-10)], CONS_FOOD), None, None, None
    ),
    ...
    ("ensalada_frutas", 0.3, 70, 0, CHEW_PATH, 3, 1, BREAKFAST_PATH, 4, BLIP_PATH,
        effects.Effect(None, [("v_frutas",20), ("dulces",25), ("energy",10), ("b_teeth",-10), ("toilet",-10)], CONS_FOOD), None, [], None
    ),
    ...
    ("helado", 0.3, 70, 0, CHEW_PATH, 3, 1, BREAKFAST_PATH, 4, BLIP_PATH,
        effects.Effect(None, [("dulces",25), ("l_quesos",50), ("energy",10), ("weight",1), ("b_teeth",-20), ("toilet",-10)], CONS_FOOD), None, [], None
    ),
    ...
    ("martin_fierro", 0.3, 70, 0, CHEW_PATH, 3, 1, BREAKFAST_PATH, 4, BLIP_PATH,
        effects.Effect(None, [("dulces",25), ("l_quesos",50), ("energy",10), ("weight",2), ("b_teeth",-20), ("toilet",-10)], CONS_FOOD), None, [], None
    ),

    
    # Sports
    ("sport_football", 0.3, 70, 0, "assets/kid/actions/football", 3, 1, None, 1, "assets/sound/jump_rope.ogg",
        effects.Effect(None, [("energy",-10), ("defenses",5), ("weight",-1.5), ("agua",-15), ("shower",-50), ("w_hands",-50), ("sports",40), ("fun",80), ("relaxing",-15)]), None, None, None
    ),
    ("sport_jump", 0.3, 70, 0, "assets/kid/actions/ropejump", 3, 1, None, 1, "assets/sound/saltar_cuerda.ogg",
        effects.Effect(None, [("energy",-5), ("defenses",2), ("weight",-0.5), ("agua",-5), ("shower",-20), ("w_hands",-20), ("sports",20), ("fun",50), ("relaxing",-5)]), None, None, None
    ),
    ("sport_run", 0.3, 70, 0, "assets/kid/actions/run", 3, 1, None, 1, None,
        effects.Effect(None, [("energy",-10), ("defenses",5), ("weight",-1.5), ("agua",-15), ("shower",-50), ("w_hands",-20), ("sports",50), ("fun",30), ("relaxing",-15)]), None, None, None
    ),
    
    # Do
    ("housekeeping", 0.3, 70, 1, "assets/kid/actions/twister", 3, 2, "assets/action-icons/clean", 1, [TWISTER_SOUND, "assets/sound/work.ogg"],
        effects.Effect(None, [("energy",-5), ("shower",-20), ("w_hands",-20), ("sports",10), ("fun",-20), ("relaxing",-5), ("housekeeping",60)]), None, None, None
    ),
    ...
    ("help_field", 0.3, 70, 1, "assets/kid/actions/twister", 3, 2, None, 1, [TWISTER_SOUND, "assets/sound/work.ogg"],
        effects.Effect(None, [("energy",-10), ("weight",-1), ("agua",-5), ("shower",-40), ("w_hands",-50), ("sports",20), ("fun",-20), ("relaxing",-10), ("housekeeping",60)]), None, None, None
    ),
    ("help_cook", 0.3, 70, 1, "assets/kid/actions/twister", 3, 1, "assets/action-icons/cook", 1, [TWISTER_SOUND, "assets/sound/work.ogg"],
        effects.Effect(None, [("energy",-5), ("shower",-10), ("w_hands",-30), ("relaxing",-5), ("housekeeping",40)], ["contento_cocinar"]), None, None, None
    ),
    ("relax", 0.3, 70, 0, "assets/kid/actions/rest", 3, 1, None, 1, ["assets/sound/relax.ogg"],
        effects.Effect(None, [("energy",30), ("defenses",10), ("fun",10), ("relaxing",40)]), None, None, None
    ),
    ...
    ("clean", 0.3, 70, 1, "assets/kid/actions/twister", 3, 1, "assets/action-icons/clean", 2, [TWISTER_SOUND, "assets/sound/work.ogg"],
        effects.Effect(None, [("energy",-5), ("shower",-10), ("w_hands",-20), ("sports",10), ("fun",-20), ("relaxing",-5), ("housekeeping",40)]), None, None, None
    ),
    ("sleep", 0.3, 150, 1, "assets/kid/actions/sleep", 3, 1, None, 2, [None, "assets/sound/sleep.ogg"],
        effects.Effect(None, [("energy",90), ("defenses",20), ("shower",-40), ("w_hands",-40), ("b_teeth",-40), ("toilet",-80), ("sports",-20), ("relaxing",90), ("housekeeping",-30), ("homework",-30)]), None, None, None, 1, None, "sleep"
    ),
    ...
    ("tv", 0.3, 70, 0, "assets/kid/actions/tv", 3, 1, None, 1, None,
        effects.Effect(None, [("energy",5), ("sports",-5), ("fun",40), ("relaxing",5)]), None, None, None
    ),
    ...
    ("dance", 0.3, 70, 0, "assets/kid/actions/dance", 3, 1, None, 1, "assets/sound/music.ogg",
        effects.Effect(None, [("energy",-5), ("weight",-1), ("agua",-5), ("shower",-10), ("sports",30), ("fun",60), ("relaxing",-5)]), None, None, None, 1, "un link"
    ),
