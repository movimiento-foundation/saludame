...
def get_tf_challenges():
    ...
    tf_challenges["physica"] = [
        ...
        _create_tf_challenge(u"El ejercicio, el disfrute del tiempo libre, el estar con amigos, el reír, el estar con la familia, el estar de buen humor, también favorecen que nuestro sistema inmune no se vea afectado.", 1, 1),
        ...
        _create_tf_challenge(u"La actividad física nos ayuda prevenir enfermedades como el sobrepeso y la obesidad.", 1, 1),
        _create_tf_challenge(u"Los niños que no realizan actividad física tienen menos probabilidades de enfermarse.", 0, 1),
        _create_tf_challenge(u"No es importante antes de empezar una actividad física, realizarnos controles médicos para saber cómo esta nuestra salud.", 0, 1),
        ...
        _create_tf_challenge(u"Los niños que no realizan actividad física no tienen más probabilidades de enfermarse.", 0, 1),
        ...
        _create_tf_challenge(u"La actividad física no nos ayuda prevenir enfermedades como el sobrepeso y la obesidad ", 0, 2),
        _create_tf_challenge(u"La actividad física ayuda a prevenir enfermedades.", 1, 2),
        _create_tf_challenge(u"La actividad física propicia una buena circulación a todos nuestro organismo.", 1, 2),
        ...
        _create_tf_challenge(u"La actividad física mantiene nuestra salud.", 1, 3),
        ...
        _create_tf_challenge(u"Las personas que tuvieron un infarto al corazón no deben hacer actividad física.", 1, 5),
        ...
        _create_tf_challenge(u"Para no ser sedentarios debemos hacer actividad física de moderada intensidad por lo menos 5 días a la semana con una duración de por lo menos30 min por día.", 1, 6),
        ...
        _create_tf_challenge(u"Es conveniente para evitar el sedentarismo, no pasar más de dos horas diarias sentados frente a la TV, la computadora, los juegos de computación.", 1, 7),
        _create_tf_challenge(u"Hacer actividad física desde niños no previene enfermedades.", 0, 7),
        _create_tf_challenge(u"Cuando estamos ingiriendo alimentos en menor proporción a lo que necesitamos, no podemos volvernos más susceptibles a las infecciones.", 0, 7),
    ...
    tf_challenges["hygiene"] = [
        ...
        _create_tf_challenge(u"Los dientes deben cepillarse siempre después de cada comida.", 1, 1),
        ...
        _create_tf_challenge(u"Cuando vengo de la escuela no es necesario lavarme las manos si no voy a comer.", 0, 1),
        _create_tf_challenge(u"Muchos alimentos pueden estar contaminados con agroquímicos, y pesticidas porque son frecuentemente usados.", 1, 2),
        _create_tf_challenge(u"Aún cuando las manos se vean limpias, pueden tener gérmenes o microorganismo que causan enfermedades.", 1, 2),
        ...
        _create_tf_challenge(u"No es importante controlar la cantidad de golosinas que como para cuidar mis dientes.", 0, 2),
        ...
        _create_tf_challenge(u"Los microbios no son visibles a simple vista en nuestras manos.", 1, 2),
        ...
        _create_tf_challenge(u"Si no me cepillo los dientes pueden invadir mis dientes unos microorganismos que se llaman caries y pueden hacer mucho daño a mi salud.", 1, 3),
        ...
        _create_tf_challenge(u"Cuando usamos agroquímicos no es necesario usar ropa de protección para no contaminarnos.", 0, 4),
        ...
        _create_tf_challenge(u"Los niños mas grandes podemos enseñar a los más pequeños a cómo deben cepillarse los dientes.", 1, 4),
        _create_tf_challenge(u"Si no me alimento bien mis encías y mis dientes pueden enfermarse.", 1, 4),
        ...
        _create_tf_challenge(u"Cuando usamos agroquímicos es importante no mezclar la ropa contaminada con la ropa no contaminada.", 1, 5),
        ...
        _create_tf_challenge(u"Los dientes de leche no deben cepillarse de la misma forma que los permanentes.", 0, 5),
        ...
        _create_tf_challenge(u"Si un diente es arrancado por un golpe lo que tenemos que hacer es ponerlo rápidamente en leche o agua fría y llevarlo al dentista inmediatamente.", 1, 5),
        ...
        _create_tf_challenge(u"En caso de haber tenido contacto con una sustancia química, y tener algún síntoma como por ejemplo ardor ocular, lavar con abundante agua, y consultar al médico lo más rápido posible.", 1, 6),
        _create_tf_challenge(u"Es recomendable que por lo menos cada 6 meses visite al dentista.", 1, 6),
        ...
        _create_tf_challenge(u"Yo tengo derecho a que controlen mis dientes para saber cómo esta mi salud.", 1, 6),
        ...
        _create_tf_challenge(u"El primer paso al lavarnos las manos es mojarnos las manos con agua corriente.", 1, 8),
        _create_tf_challenge(u"Es recomendable que visite el dentista solo cuando me duele un diente o una muela.", 0, 8),
        _create_tf_challenge(u"Para tener salud bucal es muy importante controlar el consumo de azúcar.", 1, 8),
        _create_tf_challenge(u"Los dientes deben cepillarse todas las veces que coma algo.", 1, 8),
        ...
        _create_tf_challenge(u"Las personas que fuman no pueden dañar sus dientes.", 0, 9),
        _create_tf_challenge(u"Los microbios son visibles a simple vista en nuestras manos.", 0, 9)
    ]
    
    # Nutrition
    tf_challenges["nutrition"] = [
        _create_tf_challenge(u"Cuando aprendemos hábitos saludables no estamos cuidando nuestra salud.", 0, 1),
        _create_tf_challenge(u"Tomar mucha agua, hacer ejercicio y comer frutas y verduras no ayuda a mover el intestino sin dificultad.", 0, 1),
        ...
        _create_tf_challenge(u"Las grasas saturadas las encontramos en: jamones, embutidos, manteca, margarina, varios cortes de carne de vaca, cordero, cerdo, carne de pato.", 1, 1),
        ...
        _create_tf_challenge(u"Los alimentos en su forma natural ya contienen sal, entonces el consumo moderado de sal es imprescindible para cuidar nuestra salud cardiovascular.", 1, 1),
        _create_tf_challenge(u"Los alimentos no tienen sal incluida.", 0, 1),
        _create_tf_challenge(u"El agua es el principal e imprescindible componente del cuerpo humano.", 1, 1),
        _create_tf_challenge(u"Necesitamos consumir entre 2 a 3 litros/día de agua.", 1, 1),
        ...
        _create_tf_challenge(u"Los niños deben consumir aproximadamente uno y medio litro de leche por día.", 0, 1),
        ...
        _create_tf_challenge(u"La carne, fiambres, huevos, leche, manteca, deben ser almacenados en heladera.", 1, 1),
        ...
        _create_tf_challenge(u"El consumo de fibras no es importante para poder regular los niveles de colesterol en nuestro organismo.", 0, 2),
        ...
        _create_tf_challenge(u"Las vitaminas son nutrientes que, aunque en pequeñas cantidades, son vitales para el organismo.", 1, 2),
        ...
        _create_tf_challenge(u"No deberíamos consumir huevos poco cocidos, mayonesas caseras, o merengues crudos, por el peligro de padecer una enfermedad que se llama salmonelosis y que puede ser muy grave.", 1, 2),
        ...
        _create_tf_challenge(u"Antes de manipular los alimentos, después de prepararlos, luego de consumirlos, debemos siempre lavarnos las manos por lo menos durante 30 segundos.", 1, 3),
        ...
        _create_tf_challenge(u"Si cocinamos las verduras a olla a presión o al vapor, se pierden mas vitaminas.", 0, 4),
        _create_tf_challenge(u"Cuando guardamos harinas, fideos secos, azúcar debemos hacerlo en lugares cerrados, protegidos de insectos y roedores.", 1, 4),
        ...
        _create_tf_challenge(u"Las deficiencias de vitaminas y los excesos de algunas de ellas producen enfermedades de mayor o menor gravedad.", 1, 5),
        ...
        _create_tf_challenge(u"A los alimentos debemos guardarlos junto a productos químicos como insecticidas, productos de limpieza, venenos porque los alimentos pueden contaminarse y ser muy perjudiciales para nuestra salud.", 0, 5),
        _create_tf_challenge(u"Las frutas y verduras deben ser lavadas cuidadosamente con agua de la canilla, jabón y con hipoclorito de sodio.", 1, 5),
        ...
        _create_tf_challenge(u"No es importante mantener las carnes crudas separadas de otros alimentos, así como separar los alimentos crudos de los cocidos.", 0, 6),
        _create_tf_challenge(u"Los alimentos como carnes y derivados deben colocarse en heladera lo más rápidamente luego de comprados.", 1, 6),
        _create_tf_challenge(u"Las proteínas están formadas por unas unidades básicas llamadas aminoácidos.", 1, 7),
        _create_tf_challenge(u"Las proteínas se encuentran principalmente en alimentos de origen animal (leche y derivados, carne roja, pollo, pescado y huevos etc),", 1, 7),
        _create_tf_challenge(u"El colesterol debe existir en nuestro organismo aunque siempre en determinadas cantidades. Cuando existe en exceso puede generar problemas, principalmente cardiovasculares.", 1, 7),
        ...
        _create_tf_challenge(u"El colesterol bueno o HDL colesterol tiene un rol protector a diferencia del colesterol LDL o colesterol malo.", 1, 8),
        ...
        _create_tf_challenge(u"Los alimentos en su forma natural ya contienen sal, entonces el consumo moderado de sal es imprescindible para cuidar nuestra salud cardiovascular.", 1, 8),
        ...
        _create_tf_challenge(u"Consumir alimentos ricos en calcio es imprescindible en todas las etapas de la vida para disminuir la probabilidad de tener una enfermedad cuando seamos adultos que se llama osteoporosis.", 1, 9),
    ...
    tf_challenges["spare_time"] = [            
        _create_tf_challenge(u"La actividad física solo se debe realizar en la escuela.", 0, 1),
        ...
        _create_tf_challenge(u"Si trabajamos sin parar, si estudiamos sin parar, si dormimos pocas horas, si no descansamos, si estamos estresados, corremos el riesgo de enfermar.", 1, 3),
        ...
        _create_tf_challenge(u"Es recomendable realizar como mínimo 30 min de actividad física dos veces en la semana.", 0, 4),
        _create_tf_challenge(u"Realizando actividad física podemos divertirnos, recrearnos, reírnos, conocernos.", 1, 5),
        _create_tf_challenge(u"Todos los niños y adolescentes tienen derecho a realizar actividad física para cuidar de su salud.", 1, 5),
        _create_tf_challenge(u"Si realizamos actividad física estamos de buen humor.", 1, 6),
        ...
        _create_tf_challenge(u"Es recomendable realizar todos los días 30 min de actividad física.", 1, 8),
        _create_tf_challenge(u"La recreación, la diversión y el disfrute del tiempo libre y el ocio, son parte de nuestra salud, y aportan de manera muy positiva a nuestra calidad de vida.", 1, 8),
        _create_tf_challenge(u"Con realizar actividad física 10 min por día es suficiente para estar sanos.", 0, 9),
        _create_tf_challenge(u"Es importante tomarnos un momento del día para hacer actividades que nos agraden, que nos permita el descanso, la risa, compartir, estar con amigos y recrearnos.", 1, 9)
    ]
    ...
    tf_challenges["responsability"] = [
        ...
        _create_tf_challenge(u"En mis controles en salud, me pesan y miden mi altura, para asegurarnos de que estoy creciendo bien.", 1, 1),
        ...
        _create_tf_challenge(u"Cuidar de nuestra salud es una responsabilidad que todos los niños tenemos que aprender.", 1, 1),
        ...
        _create_tf_challenge(u"En mis controles en salud, es muy importante que valoren como “veo” y como están mis ojos.", 1, 1),
        _create_tf_challenge(u"Solo debo ir al doctor cuando estoy enfermo.", 0, 1),
        _create_tf_challenge(u"En mis controles en salud es importante que examinen mi piel para ver si no tengo alguna enfermedad provocada por el sol.", 1, 1),
        _create_tf_challenge(u"En mis controles en salud no es importante que valoren como “veo”y como están mis ojos.", 0, 1),
        _create_tf_challenge(u"Cuando voy a mis controles en salud no es importante que revisen mi cuerpo.", 0, 1),
        ...
        _create_tf_challenge(u"Los rayos UV además de nuestra piel no puede dañar nuestros ojos.", 0, 1),
        ...
        _create_tf_challenge(u"En mis controles en salud es indispensable que el doctor examine mi cuerpo para ver como estamos creciendo y nos estamos desarrollando.", 1, 2),
        ...
        _create_tf_challenge(u"Las camas altas pueden llegar a medir 1 metro de ancho y hasta 15 metros de largo.", 1, 2),
        _create_tf_challenge(u"Se debe realizar una canaleta rodeando la cama alta para que el agua corra.", 1, 2),
        _create_tf_challenge(u"El mantenimiento y control de plagas es tan importante como la siembra.", 1, 2),
        _create_tf_challenge(u"Es muy importante llevar registro de los cultivos y los cuidados necesarios, para próximas siembras.", 1, 2),
        _create_tf_challenge(u"Si se siembra más de una variedad debemos colocar las de menor tamaño al centro y las de mayor al costado del cantero.", 0, 2),
        _create_tf_challenge(u"En el almácigo es más fácil cuidar las semillas que en la siembra directa.", 1, 2),
        ...
        _create_tf_challenge(u"Al cosechar debemos no dañar la planta porque es vía de entrada de microbios.", 1, 3),
        _create_tf_challenge(u"Entre las camas altas no debemos dejar caminos intermadios para circular.", 0, 3),
        _create_tf_challenge(u"El único método de sembrar es de manera directa en los canteros.", 0, 3),
        _create_tf_challenge(u"Ya que se trata de un microclima controlado, no es importante mantener el almácigo libre de yuyos.", 0, 3),
        _create_tf_challenge(u"Se debe cosechar todo lo que esté listo sin importar si lo vamos a consumir.", 0, 3),
        _create_tf_challenge(u"Debemos estudiar que plantas son compañeras y cuales no, para que no se perjudiquen entre si.", 1, 3),
        _create_tf_challenge(u"Los controles en salud no son importantes.", 0, 4),
        _create_tf_challenge(u"En mis controles en salud no aprendo muchas cosas nuevas.", 0, 4),
        ...
        _create_tf_challenge(u"Al cosechar se puede cortar las hojas, frutos, o la parte que corresponda sin tener mucho cuidado.", 0, 4),
        ...
        _create_tf_challenge(u"Debemos limpiar los utensilios de la cosecha para evitar enfermar la planta.", 1, 4),
        ...
        _create_tf_challenge(u"No debemos dejar restos de cultivos enfermos en los canteros al cosechar, sacarlos de la huerta.", 1, 5),
        _create_tf_challenge(u"Al sacar la tierra de la cama alta, debo deshacerme de ella, ya que no sirve para nada más en mi huerta.", 0, 5),
        _create_tf_challenge(u"Las formas de siembra en almácigos son: en línea, al voleo y en casilla o hueco.", 0, 5),
        _create_tf_challenge(u"Cuando la lluvia es abundante debemos retirar el agua de los canteros.", 1, 5),
        _create_tf_challenge(u"Si aparecen plagas, enfermedades o malezas podemos combatirlos con agroquímicos.", 0, 5),
        _create_tf_challenge(u"Las camas altas o canteros convienen realizarlos con una orientación Este-Oeste, a la sombra e inundable.", 0, 5),
        ...
        _create_tf_challenge(u"Al momento de cosechar debemos hacerlo en el momento indicado.", 1, 7),
        ...
        _create_tf_challenge(u"El humus provee de elementos nutritivos al suelo, mejora la retención de aire y agua en el suelo, etc.", 1, 7),
        ...
        _create_tf_challenge(u"Luego de elegido el terreno debemos limpiar la superficie, sacando piedras, vidrios y basura.", 1, 8),
        _create_tf_challenge(u"El cantero debe quedar más alto en el medio que en los bordes.", 1, 8),
        ...
        _create_tf_challenge(u"En nuestro país y en el mundo muchas personas tienen presión arterial elevada, o sea son hipertensos y por eso desde niños tenemos que controlarnos la presión arterial.", 1, 9),
        ...
        _create_tf_challenge(u"Cuando la tierra esta preparada, podemos plantar cualquier semilla sin importar la época del año en que estamos.", 0, 9),
        ...
        _create_tf_challenge(u"El almácigo retrasa la germinación de las semillas por tratarse de un microclima controlado.", 0, 9)
    ]
