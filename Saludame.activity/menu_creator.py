...
items = [
    ...
    (u"Diversión...", None, None, [
        ...
        (u"Rayuela", "hopscotch", None, None, EP),
        ...
        (u"Bailar", "dance", None, None, ["bedroom", "livingroom", "schoolyard", "square"]),
        #(u"Cantar", "sing", None, None, ["bedroom", "livingroom", "schoolyard", "square"]),
