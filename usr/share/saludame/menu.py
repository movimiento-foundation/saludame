...
#buttons
SMALL_BUTTON = os.path.join(BASEPATH, "assets/menu/A.png")
LARGE_BUTTON = os.path.join(BASEPATH, "assets/menu/B.png")
CENTER_BUTTON = os.path.join(BASEPATH, "assets/menu/center.png")
BACK_BUTTON = os.path.join(BASEPATH, "assets/menu/back.png")
QUIT_BUTTON = os.path.join(BASEPATH, "assets/menu/quit.png")
HELP_BUTTON = os.path.join(BASEPATH, "assets/menu/menu_help.png")
