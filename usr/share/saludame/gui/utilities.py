...
class Button(Widget):
    ...
    def __init__(self, container, rect, frame_rate, surface, cb_click=None, cb_over=None, cb_out=None):
        ...
        self.set_click_sound_path(os.path.join(BASEPATH,"assets/sound/click.ogg"))
...
def get_font(size, bold=False, italic=False):
    ...
    if bold:
        font = pygame.font.Font(os.path.join(BASEPATH,"assets/fonts/DroidSans-Bold.ttf"), size)
    else:
        font = pygame.font.Font(os.path.join(BASEPATH,"assets/fonts/DroidSans.ttf"), size)
