...
class MainWindow(gui.Window):
    ...
    def __init__(self, container, rect, frame_rate, clock, windows_controller, cha_loader, bars_loader, game_man):
        ...
        #btn_change_mood = gui.ImageButton(self.rect, pygame.Rect((1120, 500), (60, 60)), 1, os.path.join(BASEPATH,"assets/icons/change.png"), self._cb_button_click_change_mood)
...
class Clock(gui.Widget):
    ...
    def __init__(self, container, rect_in_container, frame_rate, game_manager):
        background = pygame.image.load(os.path.join(BASEPATH,"assets/layout/clock_background.png")).convert_alpha()
        ...
        self.frame_index = 0
        self.frame_paths = [
            os.path.join(BASEPATH,"assets/layout/clock_D.png"),
            os.path.join(BASEPATH,"assets/layout/clock_A.png"),
            os.path.join(BASEPATH,"assets/layout/clock_B.png"),
            os.path.join(BASEPATH,"assets/layout/clock_C.png"),
        ]
        self.set_frame()
