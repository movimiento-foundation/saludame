...
class CustomizationWindow(gui.Window):
    ...
    def __init__(self, container, rect, frame_rate, windows_controller, character):
        ...
        button_back = pygame.image.load(os.path.join(BASEPATH,"customization/customization_button.png")).convert_alpha()
...
MALE_PATH = os.path.join(BASEPATH,"customization/boy.png")
FEMALE_PATH = os.path.join(BASEPATH,"customization/girl.png")
