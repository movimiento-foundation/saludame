...
S_CORRECT_PATH = os.path.join(BASEPATH,"assets/sound/challenge_win.ogg")
S_OVER_PATH = os.path.join(BASEPATH,"assets/sound/over.ogg")
S_INCORRECT_PATH = os.path.join(BASEPATH,"assets/sound/challenge_lose.ogg")
...
class MultipleChoice(gui.Window):
    ...
    def __init__(self, container, rect, frame_rate, windows_controller, challenges_creator, register_id, bg_color=(0, 0, 0)):
        ...
        self.set_bg_image(os.path.join(BASEPATH,"assets/windows/window_1.png"))
    ...
    def _cb_button_click_choice(self, button):
        if button == self.choices[self.correct_index]:
            ...
            if self.tries == 1:
                ...
                self.windows_controller.windows["info_challenge_window"].update_content(u"Perdiste", u"Qué lástima, no era correcta, \n %s puntos para tu barra de %s. \nLee la biblioteca o pregunta a tu maestro/a." % (self.challenges_creator.game_man.get_current_level_conf()["multiple_choice_vector"][2], self.topic.label), os.path.join(BASEPATH,"assets/challenges/boy_sad.png"))
                self.windows_controller.set_active_window("info_challenge_window")
                self.tries = 0
            else:
                self.tries += 1
...
class InfoChallenge(gui.Window):
    def __init__(self, container, rect, frame_rate, windows_controller, challenges_creator, text_intro, text_result_good, text_result_bad, slide=None, bg_color=(0, 0, 0)):
        ...
        self.set_bg_image(os.path.join(BASEPATH,"assets/windows/window_2.png"))
        self.challenges_creator = challenges_creator
        ...
        self.image = gui.Image(rect, pygame.Rect(640, 240, 80, 80), 1, os.path.join(BASEPATH,"assets/challenges/ninio_normal.png"))
    
        self.add_child(self.title)
        self.add_child(self.text)
        self.add_child(self.image)
        
    def update_content(self, title="Verdadero o Falso", text="", image=os.path.join(BASEPATH,"assets/challenges/ninio_normal.png")):
...
#class Cooking(gui.Window):
    #def __init__(self, container, rect, frame_rate, windows_controller, register_id, bg_color=(0, 0, 0)):
        ...
        #self.dnd = []
        #self.dnd.append(gui.Image(rect, pygame.Rect(50, 100, 100, 100), 1, os.path.join(BASEPATH,"assets/events/ill.jpg")))
        #self.dnd.append(gui.Image(rect, pygame.Rect(50, 250, 100, 100), 1, os.path.join(BASEPATH,"assets/events/caries.jpg")))
        #self.dnd.append(gui.Image(rect, pygame.Rect(50, 400, 100, 100), 1, os.path.join(BASEPATH,"assets/events/unkown.png")))
        
        #self.trash = gui.Image(rect, pygame.Rect(500, 200, 200, 200), 1, os.path.join(BASEPATH,"assets/challenges/trash.png"))
